...
dates: {
  "Notimation Origin": {
                url: "notimation-origin",
                day : "10/01/2019",
                period: "Month",
                title: "How Notimation was started",
                desc: "Notimation began as a cost-effective SMS solution for my cousin's company, RollerShow. With our previous success in Negociometro, we embarked on this venture, initially planning to use Android phones with SIM cards for SMS. However, we later opted for a more robust approach, developing an API and acquiring Synways gateways.",
                img: "/images/projects/notimation/notimation_synway.png",
                location: "AV. LIBERTAD 627 Piso: 1 - PUNILLA - VILLA CARLOS PAZ (5152)",
                map: "https://maps.app.goo.gl/4k1DAwvzH4xdcajr8"
    },
}
quotes: {}
---
