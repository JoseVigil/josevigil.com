# LINKEDIN PROFILE — MASTER DOCUMENT

> This file is the single source of truth for the Jose Vigil LinkedIn profile.
> All section files reference this document.

## Profile Structure

| Section | File |
|---------|------|
| Headline | LINKEDIN_HEADLINE.md |
| About | LINKEDIN_ABOUT.md |
| Featured | (See josevigil.com, Cognituum whitepaper, Bloomaut) |
| Experience | This file |
| Content strategy | CONTENT_PILLARS.md + POST_TEMPLATES.md |

---

## Headline (active version)

See LINKEDIN_HEADLINE.md
...
then Bloomaut, then earlier roles condensed. Do not frame roles as chapters
of a C.O.M. research narrative in this profile; that framing stays in the
identity layer (essays, Cognituum product page).
...
### Earlier (condensed, one line)
Co-Founder, Negociómetro (search engine, 2016–2018) · Mobile Coordinator,
Grupo Vi-Da (native Android/PhoneGap, 2011–2013) · Flash/Flex & iPhone
Developer, Truelogic Software (2008–2011) · Founder/CEO, Padkite
